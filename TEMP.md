...
pg_dump -h db.gwjezgyzughtujndzoyv.supabase.co -U postgres -d postgres -p 5432 > backup.sql

# Backup all data to csv

psql -h db.gwjezgyzughtujndzoyv.supabase.co -U postgres -d postgres -p 5432 -Atc "SELECT tablename FROM pg_tables WHERE schemaname = 'public'" | xargs -I{} psql -h db.gwjezgyzughtujndzoyv.supabase.co -U postgres -d postgres -p 5432 -c "\copy {} to '{}.csv' CSV HEADER"
